	      ...
	      <tr>
	        ...
	        <table width="750" border="0" cellspacing="0" cellpadding="0" style="font-size:12px;">
			  ...
			  <c:if test="${not empty listMessage}">
			  	<c:forEach items="${listMessage}" var="m">
	           	  <tr>
		            <td class="lb"><div align="center">${m.rCount }</div></td>
		            <td height="25" class="lb"><span class="gray">&nbsp;<img src="Img_Background/1/jd-to.gif" width="13" height="13" border="0" />&nbsp;<a href="Jsp_Proscenium/MessageBoard_replay.jsp?id=${m.mId }" target="_parent">${m.mTitle }</a></span></td>
