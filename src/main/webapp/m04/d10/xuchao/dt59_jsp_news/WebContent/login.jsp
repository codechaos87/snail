	    ...
	    <div class="content">
	      ...
	      <ul class="classlist">
	      	<%
	      		...
	      		List<CommentInfo> listCommentInfo = (List<CommentInfo>)request.getAttribute("listCommentInfo");
	      		for(int i=0;i<listCommentInfo.size();i++){
	      		    out.print("<li><a href='newspages/news_add.html'>"+listCommentInfo.get(i).getCommentContent()+"</a><span>"+listCommentInfo.get(i).getFbtime()+"</span></li>");
	      		}
	      	%>
